...
export const DeleteBoardModal = ({ showModal, setShowModal }) => {
  ...
  return (
    <form onSubmit={() => console.log('test')} aria-hidden='true'
      ref={formRef}
      ...
      <div className=
        ...
        <div className='flex gap-4'>
          ...
          <button className='flex grow flex-row items-center rounded-3xl justify-center w-48 md:w-40 h-10 md:h-12 text-main-purple hover:bg-main-purple hover:text-white bg-main-purple/10'>
            Cancel
          </button>
        </div>
      </div>
